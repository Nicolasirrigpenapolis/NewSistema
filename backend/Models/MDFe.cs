...
namespace Backend.Api.Models
{
    public class MDFe
    {
        ...
        // === DADOS DO EMITENTE (COPIADOS DA EMPRESA NO MOMENTO DA EMISSÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢O) ===
        [Required]
        [MaxLength(14)]
        ...
        // === DADOS DO CONDUTOR (COPIADOS NO MOMENTO DA EMISSÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢O) ===
        [MaxLength(200)]
        ...
        // === DADOS DO VEÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚ÂCULO (COPIADOS NO MOMENTO DA EMISSÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢O) ===
        [MaxLength(8)]
        ...
        // CÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³digo aleatÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³rio MDFe (cMDF) - 8 dÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â­gitos obrigatÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³rios para chave de acesso
        [MaxLength(8)]
        ...
        // CÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³digo UF do emitente (obrigatÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³rio SEFAZ)
        [MaxLength(2)]
        public string? CodigoUf { get; set; }

        // DÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â­gito verificador da chave de acesso (extraÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â­do da chave)
        [MaxLength(1)]
        public string? CodigoVerificador { get; set; }

        // CÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³digo numÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©rico aleatÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³rio (usado na geraÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£o da chave)
        [MaxLength(8)]
        public string? CodigoNumericoAleatorio { get; set; }

        // VersÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£o do modal (configurÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡vel via appsettings)
        [MaxLength(10)]
        ...
        [Required]
        public int Modal { get; set; } = 1; // 1 = RodoviÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡rio
        ...
        // === CAMPOS CRÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚ÂTICOS PARA CONFORMIDADE MODELOINI.INI ===
        // Data/hora inÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â­cio da viagem (dhIniViagem) - OBRIGATÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã¢â‚¬Å“RIO
        public DateTime? DhInicioViagem { get; set; }

        // CÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³digos IBGE dos municÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â­pios de carregamento e descarregamento
        ...
        public int? Lote { get; set; } = 1; // NÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Âºmero do lote de envio

        [MaxLength(2)]
        public string UnidadeMedida { get; set; } = "01"; // Fixo em '01' = Quilograma (padrÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£o do sistema)

        [MaxLength(500)]
        public string? InfoAdicional { get; set; }

        [MaxLength(20)]
        public string StatusSefaz { get; set; } = MDFeStatus.Rascunho;
    ...
    // Caminhos e conte�do relacionado a artefatos persistidos
    [MaxLength(500)]
    public string? IniPath { get; set; }

    [Column(TypeName = "nvarchar(max)")]
    public string? UltimoIniConteudo { get; set; }

    [MaxLength(500)]
    public string? XmlAutorizadoPath { get; set; }

        public virtual ICollection<MDFeStatusHistory> StatusHistorico { get; set; } = new List<MDFeStatusHistory>();
        ...
        [MaxLength(2)]
        public string? TipoCarga { get; set; } // 01=Granel sÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³lido, 02=Granel lÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â­quido, etc.
        ...
        // Dados do ProprietÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡rio do VeÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â­culo (se diferente do emitente)
        ...
        // === DADOS DO CONTRATANTE (COPIADOS NO MOMENTO DA EMISSÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢O) ===
        ...
        // === DADOS DA SEGURADORA (COPIADOS NO MOMENTO DA EMISSÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢O) ===
        public int? SeguradoraId { get; set; }
        public virtual Seguradora? Seguradora { get; set; }

        [MaxLength(1)]
        public string? TipoResponsavelSeguro { get; set; } // 1=Emitente, 2=Contratante, 3=Outros, 4=DestinatÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡rio, 5=Remetente
        ...
        [MaxLength(1)]
        public string? TipoPagamento { get; set; } // 0=ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ vista, 1=Prazo, 2=Outros

        // === VALE PEDÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚ÂGIO ===
        [Column(TypeName = "nvarchar(max)")]
        ...
        public virtual ICollection<MDFePagamento> Pagamentos { get; set; } = new List<MDFePagamento>();
        public virtual ICollection<MDFeAutorizacaoDownloadXml> AutorizacoesXml { get; set; } = new List<MDFeAutorizacaoDownloadXml>();
        public MDFeResponsavelTecnico? ResponsavelTecnico { get; set; }
        ...
        // Unidades de carga agregadas diretamente ao MDFe ou �s unidades de transporte
        ...
        /// <summary>
        /// Total de documentos (CTe + NFe) - cÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡lculo simplificado
        /// </summary>
        [NotMapped]
        ...
        /// <summary>
        /// Indica se o MDFe estÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡ autorizado
        /// </summary>
        [NotMapped]
        public bool EstaAutorizado => StatusSefaz == "AUTORIZADO";

        // =====================================
        // MÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â°TODOS DE NEGÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã¢â‚¬Å“CIO (DDD)
        // =====================================

        /// <summary>
        /// Cria snapshots dos dados atuais das entidades relacionadas
        /// Implementa o conceito de Value Objects mantendo dados imutÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡veis
        /// </summary>
        public void CriarSnapshotsEntidades()
        {
            ...
            if (Veiculo != null)
            {
                ...
                // Valores padrÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£o para campos nÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£o disponÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â­veis no modelo atual
                VeiculoTipoRodado = "01"; // Truck
                VeiculoTipoCarroceria = "00"; // NÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£o aplicÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡vel
            }
        }

        public void RegistrarStatus(string status, string? motivo = null, string? responsavel = null, string? traceId = null)
        {
            var statusNormalizado = status?.ToUpperInvariant() ?? string.Empty;
            var statusAtual = StatusSefaz?.ToUpperInvariant();

            if (!string.IsNullOrEmpty(statusAtual) && statusAtual == statusNormalizado)
            {
                return;
            }

            StatusSefaz = statusNormalizado;
            DataUltimaAlteracao = DateTime.Now;

            StatusHistorico ??= new List<MDFeStatusHistory>();
            StatusHistorico.Add(new MDFeStatusHistory
            {
        ...
        /// <summary>
        /// Gera prÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³ximo nÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Âºmero do MDFe para um emitente especÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â­fico
        /// </summary>
        ...
        /// <summary>
        /// Valida se o MDFe estÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡ pronto para transmissÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£o
        /// </summary>
        public (bool IsValid, List<string> Errors) ValidarParaTransmissao()
        {
            var erros = new List<string>();

            // ValidaÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Âµes de dados obrigatÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³rios
            if (string.IsNullOrEmpty(EmitenteCnpj))
                erros.Add("CNPJ do emitente ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â© obrigatÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³rio");

            if (string.IsNullOrEmpty(CondutorNome))
                erros.Add("Nome do condutor ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â© obrigatÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³rio");

            if (string.IsNullOrEmpty(VeiculoPlaca))
                erros.Add("Placa do veÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â­culo ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â© obrigatÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³ria");

            if (TotalDocumentos == 0)
                erros.Add("ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â° necessÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡rio pelo menos um documento (CTe ou NFe)");

            if (PesoBrutoTotal <= 0)
                erros.Add("Peso bruto total deve ser maior que zero");

            if (string.IsNullOrEmpty(UfIni) || string.IsNullOrEmpty(UfFim))
                erros.Add("UF de inÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â­cio e fim sÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£o obrigatÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³rias");

            if (string.IsNullOrEmpty(ChaveAcesso))
                erros.Add("Chave de acesso nÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£o foi gerada");
        ...
        {
            // CÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡lculo simplificado baseado nos locais de carregamento
            var totalLocais = LocaisCarregamento?.Count ?? 0;

            // Em produÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£o, buscar valores reais dos documentos
        ...
        /// <summary>
        /// Gera chave de acesso do MDFe (implementaÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£o simplificada)
        /// </summary>
        public string GerarChaveAcesso()
        {
            // Usar dados do snapshot se disponÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â­veis, senÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£o usar da entidade relacionada
            ...
            if (string.IsNullOrEmpty(emitenteUf) || string.IsNullOrEmpty(emitenteCnpj))
                throw new InvalidOperationException("Dados do emitente sÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£o obrigatÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³rios para gerar chave");
            ...
            // Gerar cÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³digo aleatÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³rio se nÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£o existir (usar CodigoMDF prioritariamente)
            if (string.IsNullOrEmpty(CodigoMDF) && string.IsNullOrEmpty(CodigoNumericoAleatorio))
            {
                CodigoMDF = new Random().Next(10000000, 99999999).ToString();
            }

            // Usar CodigoMDF se disponÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â­vel, senÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£o usar CodigoNumericoAleatorio
            var codigoAleatorio = CodigoMDF ?? CodigoNumericoAleatorio ?? new Random().Next(10000000, 99999999).ToString();

            var chaveSemDv = $"{codigoUf}{ano}{mes}{cnpj}{modelo}{serie}{numero}{tipoEmissao}{codigoAleatorio}";

            // Calcular dÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â­gito verificador (implementaÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£o simplificada)
        ...
        /// <summary>
        /// Calcula dÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â­gito verificador da chave (implementaÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£o simplificada)
        /// </summary>
        private int CalcularDigitoVerificador(string chave)
        {
            // ImplementaÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£o simplificada - em produÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£o usar algoritmo mÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³dulo 11 oficial
            return chave.Sum(c => int.Parse(c.ToString())) % 10;
        }

        /// <summary>
        /// ObtÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©m cÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³digo IBGE da UF para usar na chave de acesso
        /// </summary>
        private string ObterCodigoUfIBGE(string uf)
        {
            ...
            {
                throw new InvalidOperationException($"UF '{uf}' nÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£o ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â© vÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡lida para geraÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£o da chave de acesso");
            }
    ...
    // Condutores adicionais do MDFe (alÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©m do principal)
    ...
    // Vale-pedÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡gio vinculado ao MDFe
    ...
    // Pagamentos vinculados ao MDFe
    public class MDFePagamento
    {
        public int Id { get; set; }
        ...
        [MaxLength(1)]
        public string TipoPagamento { get; set; } = "0";
        ...
        public virtual ICollection<MDFePagamentoComponente> Componentes { get; set; } = new List<MDFePagamentoComponente>();
        public virtual ICollection<MDFePagamentoPrazo> Prazos { get; set; } = new List<MDFePagamentoPrazo>();
        public virtual ICollection<MDFePagamentoBanco> DadosBancarios { get; set; } = new List<MDFePagamentoBanco>();
    }

    public class MDFePagamentoComponente
    {
        public int Id { get; set; }

        [Required]
        public int PagamentoId { get; set; }
        public virtual MDFePagamento Pagamento { get; set; } = null!;

        [Required]
        [MaxLength(2)]
        public string TipoComponente { get; set; } = "01";
    ...
    public class MDFePagamentoPrazo
    {
        public int Id { get; set; }
    ...
    public class MDFePagamentoBanco
    {
        public int Id { get; set; }
    ...
    public class MDFeAutorizacaoDownloadXml
    {
        public int Id { get; set; }
    ...
    public class MDFeResponsavelTecnico
    {
        public int Id { get; set; }
    ...
    // Lacres rodoviÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡rios do MDFe
    ...
    public class MDFeUnidadeTransporte
    {
        ...
        [Required]
        [MaxLength(1)]
        public string TipoUnidadeTransporte { get; set; } = string.Empty; // 1-RodoviÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡rio TraÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£o, 2-RodoviÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡rio Reboque, etc.
    ...
    // Classe bÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡sica para CT-e vinculado ao MDFe (simplificada)
    ...
    // Classe bÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡sica para NF-e vinculada ao MDFe (simplificada)
    ...
    // Classe bÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡sica para MDFe de transporte (simplificada)
    ...
    public class MDFeUnidadeCarga
    {
        ...
        public virtual MDFeUnidadeTransporte? UnidadeTransporte { get; set; }
    ...
    // Classe para prestaÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â£o parcial de NFe
