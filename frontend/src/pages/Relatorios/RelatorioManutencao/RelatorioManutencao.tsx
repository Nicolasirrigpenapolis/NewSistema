      ...
      <div className="w-full px-2 py-4">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-foreground mb-1">Relatório de Manutenção</h1>
              <p className="text-muted-foreground text-lg">Controle de manutenções de veículos</p>
            </div>
          </div>
          ...
          {manutencoes.length === 0 ? (
            ...
            <>
              ...
              {manutencoes.map((manutencao) => (
                <div key={manutencao.id} className="grid grid-cols-8 gap-4 p-4 border-b border-gray-200 dark:border-0 hover:bg-background dark:hover:bg-gray-700 transition-colors duration-200">
