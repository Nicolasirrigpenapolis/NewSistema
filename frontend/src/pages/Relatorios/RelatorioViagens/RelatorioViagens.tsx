...
import { Icon } from '../../../ui';
import { relatoriosService, RelatorioDespesasFiltro, RelatorioDespesasItem, TodosTiposDespesa } from '../../../services/relatoriosService';
...
export function RelatorioViagens() {
  ...
  const aplicarFiltros = () => {
    const novosFiltros: RelatorioDespesasFiltro = {
      ...
      placa: filtrosTemp.placa ? filtrosTemp.placa.trim() : undefined,
  ...
  const temFiltrosAtivos = Boolean(filtros.dataInicio || filtros.dataFim || filtros.placa || filtros.tipoDespesa);
  ...
  const abrirModalVisualizacao = useCallback((viagem: RelatorioDespesasItem) => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="w-full px-2 py-4">
        ...
        <div className="flex flex-col gap-4 mb-6 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-foreground mb-1">Economia de Viagens</h1>
              <p className="text-muted-foreground text-lg">
                Analise o desempenho financeiro das viagens e identifique oportunidades de otimização.
              </p>
            </div>
          </div>
          <div className="flex flex-wrap items-center gap-3">
            <button
              ...
              className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-semibold transition-all duration-200 flex items-center gap-2 shadow-lg hover:shadow-xl"
            >
              <Icon name="download" />
              Exportar
            </button>
        ...
        <div className="mb-6">
          <div className="flex flex-col gap-4 mb-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
              <h2 className="text-2xl font-bold text-foreground">Lançamentos consolidados</h2>
              <p className="text-muted-foreground mt-1">
                Visualize receitas, despesas e margens filtrando por período, veículo ou responsável financeiro.
              </p>
            </div>
            <div className="flex flex-wrap items-center gap-2">
              <button
                onClick={() => setModalExportacao(true)}
                className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-blue-600 hover:bg-blue-700 text-white transition-colors shadow-sm hover:shadow-md"
              >
        ...
        actions={viagemAtual ? [
          {
            ...
            onClick: () => {
              ...
              navigate(`/viagens/editar/${viagemAtual.id}`);
            },
            variant: 'primary'
          }
        ] : []}
      ...
      <ModalExportacao
        ...
        opcoesFiltros={{
          tiposDespesa: tipoDespesaOptions,
